                ...
                <form onSubmit={(e) => void handleSubmit(e)} className="space-y-8">
                    <div className="grid grid-cols-2 gap-x-12 gap-y-6 text-[11px] font-bold">
                        ...
                        <div>
                            ...
                            <input
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-100 outline-none"
                        ...
                        <div>
                            ...
                            <input
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-100 outline-none"
                                value={selectedOrder.surname || ''}
                                onChange={e => setSelectedOrder({ ...selectedOrder, surname: e.target.value })}
                            />
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-100 italic text-blue-600 outline-none"
                        ...
                        <div>
                            ...
                            <select
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-50 outline-none"
                                value={selectedOrder.course || ''}
                                onChange={e => setSelectedOrder({ ...selectedOrder, course: e.target.value })}
                            >
                        ...
                        <div>
                            ...
                            <select
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-50 outline-none"
                                value={selectedOrder.course_format || ''}
                                onChange={e => setSelectedOrder({ ...selectedOrder, course_format: e.target.value })}
                            >
                        ...
                        <div>
                            ...
                            <select
                                className="w-full border-2 border-gray-100 p-3 rounded-xl bg-gray-50 outline-none"
                                value={selectedOrder.course_type || ''}
                                onChange={e => setSelectedOrder({ ...selectedOrder, course_type: e.target.value })}
                            >
                    ...
                    <div className="flex justify-end gap-3 pt-8 border-t">
                        <button
                            type="button"
                            onClick={onClose}
                            className="px-12 py-3 bg-red-50 text-red-500 rounded-2xl font-black uppercase text-[10px] hover:bg-red-500 hover:text-white transition-all shadow-sm"
                        >
                            CLOSE
                        </button>
                        <button
